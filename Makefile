# This Makefile is for the Oracle::Trigger extension to perl.
#
...
TO_INST_PM = Trigger.pm

PM_TO_BLIB = Trigger.pm \
	$(INST_LIBDIR)/Trigger.pm
...
manifypods : pure_all Trigger.pm
	@$(POD2MAN) \
	Trigger.pm \
	$(INST_MAN3DIR)/Oracle::Trigger.$(MAN3EXT)
